...
<div class="columns">
	<div class="column is-half is-offset-one-quarter">
		<div class="card m-t-30">
			<div class="card-image is-vertical-center p-t-20">
				<div>
					<figure class="image is-128x128">
						<img src="{{asset('imgs/logo-2.png')}}" alt="Placeholder image">
					</figure>
				</div>
			</div>
			<div class="card-content">
				...
				<form action="" method="POST" role="form">
					...
					{{-- First Form Lable and input End --}}
					{{-- Second Form Lable and input start --}}
					<div class="field">
